...
<%
	...
	String redirect_uri = URLEncoder.encode("http://192.168.124.238:9090/sso/common/test/callback_local.jsp");
	...
	if( error.equals("") ){
		...
		if(!"".equals(ses_state) && state.equals(ses_state)){
			...
			String url = "http://192.168.124.238:9090/sso/user/oidc/api/token";
